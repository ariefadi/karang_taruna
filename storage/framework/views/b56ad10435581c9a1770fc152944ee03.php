...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Tambah data
            <a href="<?php echo e(route('admin.index')); ?>" class="btn btn-primary float-end">Kembali</a>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/karang_taruna/resources/views/admin/add.blade.php ENDPATH**/ ?>